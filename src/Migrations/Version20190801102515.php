 ...
 */
final class Version20190801102515 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE feedback (id INT AUTO_INCREMENT NOT NULL, user_from_id INT DEFAULT NULL, user_to_id INT DEFAULT NULL, activity_id INT DEFAULT NULL, stars INT NOT NULL, comment LONGTEXT DEFAULT NULL, INDEX IDX_D229445820C3C701 (user_from_id), INDEX IDX_D2294458D2F7B13D (user_to_id), INDEX IDX_D229445881C06096 (activity_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
