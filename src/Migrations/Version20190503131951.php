 ...
 */
final class Version20190503131951 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE technology DROP version');
        $this->addSql('ALTER TABLE user CHANGE role position VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE technology ADD version VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE user CHANGE position role VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
