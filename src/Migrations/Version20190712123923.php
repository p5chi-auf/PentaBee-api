 ...
 */
final class Version20190712123923 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD avatar_id INT DEFAULT NULL, CHANGE password_changed_at password_changed_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP avatar_id, CHANGE password_changed_at password_changed_at DATETIME DEFAULT NULL');
    }
}
